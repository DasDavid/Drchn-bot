...
//---------------------------------------------------------------------
	 ...
	 author: "DBM Mods, Lasse and Hexeract",
...
<div>
	<div style="padding-top: 8px; width: 70%;">
		...
		<select id="info" class="round">
			...
			<option value="6">Message Length</option>
			<option value="7">Message Is Pinned?</option>
			<option value="8">Message Is TTS?</option>
			<option value="9">Message edited at</option>
			<option value="10">Message edit history</option>
			<option value="11">Message is pinnable?</option>
			<option value="12">Message includes @everyone mention?</option>
			<option value="13">Messages different reactions count</option>
			<option value="14">Messages mentioned users list</option>
			<option value="15">Messages mentioned users count</option>
		</select>
	</div>
</div><br>
<div>
